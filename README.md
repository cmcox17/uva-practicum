...
## Follow-on Tasks
First thing I would want to do is implement styling for other device types and screen sizes. As of writing, I only have styles aligned for 2560x1440p displays. I chose to build and test it primarily at 2560x1440 since it was the closest to the width of the .psd file I was provided. I also went through and adjusted some styling for smaller monitors, but lack a native 1920x1080 monitor so I would want to go back and properly test that since it is a common format. Similary, mobile formats are likely the most common in the modern age and the design and style should be presentable at these formats.